  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex flex-col w-full bg-white shadow-sm">
      ...
      <div className="hidden xl:block w-full h-9 bg-[#355ED1]">
        <div className="container mx-auto h-full flex items-center justify-center gap-8 text-[12px] text-white">
      ...
      >
        <div className="w-full max-w-[1440px] mx-auto px-1 lg:px-0.5 flex items-center justify-between relative">
          ...
          <div className="flex items-center gap-12 lg:gap-16">
            ...
            <Link href="/" className="relative h-11 w-48 shrink-0">
              <Image src="/logos/aptagon-new-logo.png" alt="Aptagon Technologies Logo" fill className="object-contain" priority />
            </Link>
            ...
            <div className="flex flex-col px-6 py-4 gap-1">
              ...
              <div>
                <button
                  ...
                  className={`w-full flex items-center justify-between py-3 text-[15px] font-semibold transition-colors ${
                    pathname.includes("/services") || mobileServicesOpen
                      ? "text-[#355ED1]"
